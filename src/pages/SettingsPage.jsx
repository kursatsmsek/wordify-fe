        ...
        <div className="flex justify-center py-10 px-4">
            <div className="flex flex-col max-w-[800px] w-full gap-2">
                            ...
                            <div className="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-xl gap-1">
                                {["TR_TO_EN", "EN_TO_TR"].map((dir) => (
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded-lg text-sm font-bold transition-all ${localSettings.quizDirection === dir
                            ...
                            <div className="flex gap-3 flex-wrap">
                                {COLOR_PALETTES.map((palette) => (
                                    <button
                                        ...
                                        title={palette.name}
                                        className={`size-8 rounded-full transition-all hover:scale-110 ${localSettings.colorPalette === palette.value
                ...
                <div className="mt-8 flex justify-end gap-4 animate-fade-up">
                    ...
                    <button
                        onClick={handleSave}
                        className={`px-8 py-3 rounded-xl font-bold text-sm shadow-sm transition-all hover:-translate-y-0.5 flex items-center gap-2 ${saved
...
function Toggle({ checked, onChange }) {
    return (
        <label className="relative flex h-7 w-13 cursor-pointer items-center rounded-full p-1 transition-colors"
            style={{ backgroundColor: checked ? "var(--color-primary)" : "#e2e8f0", width: "52px" }}
        >
            <input
                type="checkbox"
                className="sr-only"
