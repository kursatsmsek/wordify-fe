  ...
  return (
    <div className="flex justify-center py-8 px-4">
      <div className="flex flex-col max-w-[1100px] w-full gap-6">
        ...
        {/* Table */}
        <div
          className="overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm animate-fade-up"
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 dark:bg-slate-800/50">
                  <th className="px-3 sm:px-6 py-4 text-slate-500 dark:text-slate-400 text-xs font-bold uppercase tracking-wider">
                    English Word
                  </th>
                  <th className="px-3 sm:px-6 py-4 text-slate-500 dark:text-slate-400 text-xs font-bold uppercase tracking-wider">
                    Turkish Meaning
                  ...
                  <th className="px-3 sm:px-6 py-4 text-slate-500 dark:text-slate-400 text-xs font-bold uppercase tracking-wider text-right">
                    Actions
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                {loading && words.length === 0 ? (
                  <tr>
                    <td
                      colSpan={5}
                      className="px-3 sm:px-6 py-16 text-center text-slate-400"
                    >
                      <span className="material-symbols-outlined text-3xl block mb-2 animate-spin">
                        refresh
                      </span>
                      Loading...
                    </td>
                  ...
                  <tr>
                    <td
                      colSpan={5}
                      className="px-3 sm:px-6 py-16 text-center text-slate-400 dark:text-slate-600"
                    >
                    ...
                    >
                      ...
                      <td className="px-3 sm:px-6 py-4">
                        <div className="flex items-center gap-2 sm:gap-3">
                          <div className="hidden sm:block w-20 sm:w-24 h-1.5 rounded-full bg-slate-100 dark:bg-slate-800 overflow-hidden">
                            <div
                      ...
                      <td className="px-3 sm:px-6 py-4 text-right">
                        <button
                          ...
                          className={`p-2 rounded-full transition-all text-sm flex items-center gap-1 ml-auto ${
